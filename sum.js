...
inp_arr = uinpt.split(/(?:,| )+/);
document.getElementById("fetch").style.backgroundColor =   "transparent";
document.getElementById("decode").style.backgroundColor = "transparent";
document.getElementById("load").style.backgroundColor = "transparent";
document.getElementById("store").style.backgroundColor = "transparent";
document.getElementById("execute").style.backgroundColor = "transparent";
...
if (type == "rmemloc") { // for [ax+b] type
  ...
  if (mem >= 0 && mem < 16) {
    ...
    address = address.padStart(8, "0");
    return "111111" + "0" + "0" + "00" + "110" + address;
  }
}
...
if (type == "reg") {
  ...
  if (x >= 0 && x < 16) {
    ...
    cycles.load = true;
    cycles.store = true;
    address = x.toString(2);
    address = address.padStart(8, "0");
    return "111101" + "0" + "0" + "00" + "110" +address;
  }
  else {
    return invalid;
  }
...
switch (flag_get(des, src)) {
  ...
  case "reg_memloc":
    ...
    if (x >= 0 && x < 16) {
      ...
      address = x.toString(2);
      address = address.padStart(8, "0");
      return "000010" + "0" + "1" + "00" + get_regcode(des) + "110" + address;
    }
    break;
  case "reg_rmemloc":
    var x = src.substring(1, src.length - 1);
